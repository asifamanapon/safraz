...
@endphp
   ...
   <header>
    ...
    <a href="index.html" class="logo__white"><img src="{{ asset('frontend/assets/img/logo/logo_black') }}" alt=""></a>
    </div>
    <div class="navbar__wrap main__menu d-none d-xl-flex">
    <ul class="navigation">

    <li class="{{ ($route == 'home.blog') ? 'active' : '' }}"><a href="{{ route('home') }}">Home</a></li>
