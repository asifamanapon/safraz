...
@endsection
    ...
    <a href="services-details.html" class="btn border-btn"></a>
    </div>
    </div>
    </div>
    <div class="col-xl-3">
    ...
    <h2 class="title">A clear process is the basis of success</h2>
    </div>
    </div>
    </div>
  ...
  @include('frontend.home_all.portfolio')
    ...
    <p>We are motivated by the satisfaction of our clients. Put your trust in our team of expert.Our goal is to achieve continuous.</p>
    <div class="testimonial__avatar">
        <span>Safraz Bin Anamul</span>
    </div>
    </div>
    </div>
    <div class="testimonial__item">
    ...
    <div class="testimonial__content">
    <p>We are really greatful in your services</p>
    <div class="testimonial__avatar">
        <span>Safraz Bin Anamul</span>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="homeContact__content">
                                    <p>There are many collective information</p>
                                    <h2 class="mail"><a href="mailto:Info@webmail.com">Safraz@gmail.com</a></h2>
                                </div>
                            </div>
                            <div class="col-lg-6">
