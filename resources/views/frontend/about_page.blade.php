                    ...
                    <div class="col-md-6 col-sm-9">
                        <div class="about__award__item">
                            ...
                            <div class="award__content">
                                <h5 class="title">Best districts blogger award in 2022</h5>
                                <p>There are many informative collections</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-9">
                        <div class="about__award__item">
                            ...
                            <div class="award__content">
                                <h5 class="title">B.Sc final examination 2023</h5>
                                <p>There are many variations informations</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-9">
                        <div class="about__award__item">
                            ...
                            <div class="award__content">
                                <h5 class="title">User research award 2023</h5>
                                <p>There are many variations information page, </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-9">
                        <div class="about__award__item">
                            ...
                            <div class="award__content">
                                <h5 class="title">aurthor award 2021</h5>
                                <p>There are many variations informations,</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="about__education__item">
                            <h3 class="title">B.Sc Engineering Northern University</h3>
                            <span class="date">2019 – 2023</span>
                            <p>There are many variations information,</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="about__education__item">
                            <h3 class="title">Advisor at Rahim Group</h3>
                            <span class="date">2021 – Present</span>
                            <p>There are many variations informatins.</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="about__education__item">
                    ...
                    <div class="col-md-6">
                        <div class="about__education__item">
                            <h3 class="title">Personal blogger</h3>
...
<div class="col-xl-3 col-lg-4 col-md-6">
    <div class="services__style__two__item">
        ...
        <div class="services__style__two__content">
            ...
            <p>Earn more and more peoples in our blogging site.
...
<div class="col-xl-3 col-lg-4 col-md-6">
    <div class="services__style__two__item">
        ...
        <!-- <div class="services__style__two__content">
            <h3 class="title"><a href="services-details.html">Visual</a></h3>
            <p>Strategy is a forward-looking plan.</p>
            <a href="services-details.html" class="services__btn"><i class="far fa-long-arrow-right"></i></a>
        </div> -->
    </div>
</div>
<div class="col-xl-3 col-lg-4 col-md-6">
    <div class="services__style__two__item">
        ...
        <div class="services__style__two__content">
            <h3 class="title"><a href="services-details.html">Product aurthors</a></h3>
            <p>There are many informations</p>
            <a href="services-details.html" class="services__btn"><i class="far fa-long-arrow-right"></i></a>
        </div>
    </div>
</div>
...
<div class="col-xl-3 col-lg-4 col-md-6">
    <div class="services__style__two__item">
        ...
        <div class="services__style__two__content">
            ...
            <p>The majority is customers servies.</p>
            <a href="services-details.html" class="services__btn"><i class="far fa-long-arrow-right"></i></a>
        </div>
    </div>
</div>
...
<div class="col-xl-3 col-lg-4 col-md-6">
    <div class="services__style__two__item">
        ...
        <div class="services__style__two__content">
            <h3 class="title"><a href="services-details.html">Design</a></h3>
            <p>You will find some wonderful daily life design cillections here</p>
            <a href="services-details.html" class="services__btn"><i class="far fa-long-arrow-right"></i></a>
        </div>
    </div>
</div>
    ...
    <div class="testimonial__two__active">
        <div class="testimonial__item">
            ...
            <div class="testimonial__content">
                <p>Our goal is to achieve continuous.</p>
...
<div class="blog__post__item">
    ...
    <div class="blog__post__content">
        ...
        <h3 class="title"><a href="blog-details.html">Facebook informative news</a></h3>
...
<div class="blog__post__item">
    ...
    <div class="blog__post__content">
        <span class="date">13 january 2023</span>
        <h3 class="title"><a href="blog-details.html">How to increase your productivity at work - 2023</a></h3>
        <a href="blog-details.html" class="read__more">Read mORe</a>
    </div>
</div>
</div>
...
<div class="col-lg-6">
    ...
    <div class="homeContact__content">
        <p>There are many informative collections</p>
        <h2 class="mail"><a href="mailto:Info@webmail.com">safrazbina@gmail.com</a></h2>
    </div>
</div>
<div class="col-lg-6">
